...
Generally, the more meaningful benchmarks were run using the CNN from the tutorial, with an extra linear layer at the end (126,177,929 parameters).
You need to verify this in some way (e.g. by looking at the committed code at the time your ran the benchmark).
